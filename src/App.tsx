  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans overflow-hidden relative transition-colors duration-200">
      ...
      <motion.aside 
        ...
        className={cn(
          "bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col z-40 h-full transition-all duration-300 ease-in-out",
      ...
      >
        <div className="p-6 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            {(isSidebarOpen || windowWidth >= 1024) && (
              <motion.span 
                ...
                className="font-bold text-xl tracking-tight text-slate-800 dark:text-slate-100 whitespace-nowrap"
              >
                StudyOS
              </motion.span>
            )}
          ...
          {windowWidth < 1024 && isSidebarOpen && (
            <button onClick={() => setIsSidebarOpen(false)} className="lg:hidden p-2 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300">
              <X size={20} />
            </button>
          )}
        </div>
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800 hidden lg:block">
          <button 
            ...
            className="w-full flex items-center justify-center p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-slate-500 dark:text-slate-400"
          >
      ...
      <main className="flex-1 flex flex-col overflow-hidden w-full">
        {/* Header */}
        <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 lg:px-8 z-10 shrink-0 transition-colors duration-200">
          <div className="flex items-center gap-3 flex-1 max-w-xl">
            ...
            <div className="relative w-full">
              ...
              <input 
                type="text" 
                placeholder="Search..."
                className="w-full pl-9 pr-4 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 dark:text-slate-100 transition-all"
                value={searchQuery}
          ...
          <div className="flex items-center gap-3 ml-4">
            ...
            <div className="hidden sm:flex flex-col items-end">
              <span className="text-xs font-semibold text-slate-700 dark:text-slate-200">Chemistry Prep</span>
              <span className="text-[10px] text-slate-500 dark:text-slate-400">GATE / JAM</span>
            </div>
            <div className="w-8 h-8 rounded-full bg-slate-200 dark:bg-slate-700 border border-white dark:border-slate-800 shadow-sm overflow-hidden shrink-0">
            ...
            {activeTab === 'dashboard' && (
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="h-[300px] w-full">
                      <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={progressData}>
                          ...
                          <Tooltip 
                            contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.1)', backgroundColor: isDarkMode ? '#1e293b' : '#ffffff', color: isDarkMode ? '#f1f5f9' : '#0f172a' }}
                          />
                  ...
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                    <h3 className="text-lg font-bold mb-6 dark:text-slate-100">Recent Resources</h3>
                    <div className="space-y-4">
                      {CHEMISTRY_RESOURCES.slice(0, 4).map(resource => (
                        <div key={resource.id} className="flex items-center justify-between p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border border-transparent hover:border-slate-100 dark:hover:border-slate-700 group">
            ...
            {activeTab === 'vault' && (
              ...
              >
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-6 gap-4">
                  <div>
                    <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Resource Vault</h2>
                    <p className="text-slate-500 dark:text-slate-400">Access all previous year question papers and answer keys.</p>
                  </div>
                  <div className="flex flex-col gap-4 w-full lg:w-auto">
                    <div className="relative w-full">
                      ...
                      <input 
                        ...
                        className="w-full pl-9 pr-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 dark:text-slate-100 transition-all shadow-sm"
                            ...
                            <button 
                              ...
                              className={cn(
                                ...
                                isSelected 
                                  ...
                                  : "bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 hover:border-emerald-500 dark:hover:border-emerald-500 hover:text-emerald-600 dark:hover:text-emerald-400 text-slate-700 dark:text-slate-300"
                              )}
                            >
                              {cat}
                            </button>
                            ...
                            <button 
                              ...
                              className={cn(
                                ...
                                isSelected 
                                  ...
                                  : "bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 hover:border-blue-500 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 text-slate-700 dark:text-slate-300"
                              )}
                            >
                              {type}
                            </button>
                ...
                <div className="mb-8 bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row gap-4 items-center">
                  <div className="flex-1 w-full relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-500/20 dark:text-slate-100 transition-all"
                      value={youtubeLink}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1 min-h-0">
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <span className={cn(
                            ...
                            resource.category === 'GATE' ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400" :
                            resource.category === 'JAM' ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400" :
                  ...
                  <div className={cn(
                    "lg:col-span-2 bg-slate-200 dark:bg-slate-800 rounded-3xl overflow-hidden relative border border-slate-300 dark:border-slate-700 shadow-inner flex flex-col",
                    ...
                    {selectedResource ? (
                      <>
                        <div className="bg-white dark:bg-slate-900 p-4 border-b border-slate-300 dark:border-slate-800 flex items-center justify-between">
                          ...
                          <a 
                            ...
                            className="flex items-center gap-2 text-[10px] font-bold text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 shrink-0"
                          >
                      ...
                      <div className="flex flex-col items-center justify-center h-full text-slate-400 dark:text-slate-500 gap-4 p-12 text-center">
                        <div className="w-20 h-20 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center">
                          <BookOpen size={40} />
                        </div>
                        <div>
                          <p className="font-bold text-lg text-slate-500 dark:text-slate-400">Select a resource to view</p>
              ...
              >
                {!quizStarted && !quizFinished ? (
                  <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8">
                    <div className="w-24 h-24 bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 rounded-3xl flex items-center justify-center shadow-xl shadow-amber-100 dark:shadow-none">
                      <Trophy size={48} />
                    </div>
                    <div className="space-y-4">
                      <h2 className="text-4xl font-black text-slate-800 dark:text-slate-100 tracking-tight">Test Center</h2>
                      <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto">
                        Select an assessment to test your knowledge with high-yield questions.
                      </p>
                      <div className="flex items-center justify-center gap-3 mt-4">
                        <div 
                          className="flex items-center gap-3 bg-white dark:bg-slate-900 px-6 py-3 rounded-full border border-slate-200 dark:border-slate-800 shadow-sm cursor-pointer hover:border-emerald-500 dark:hover:border-emerald-500 transition-colors" 
                          onClick={() => setIsTimedMode(!isTimedMode)}
                        >
                          <div className={`w-10 h-6 rounded-full p-1 transition-colors ${isTimedMode ? 'bg-emerald-500' : 'bg-slate-200 dark:bg-slate-700'}`}>
                            <div className={`w-4 h-4 rounded-full bg-white transition-transform ${isTimedMode ? 'translate-x-4' : 'translate-x-0'}`} />
                          </div>
                          <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Timed Mode</span>
                        </div>
                      </div>
                    </div>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
                      <div className="group bg-white dark:bg-slate-900 p-6 rounded-3xl border-2 border-slate-100 dark:border-slate-800 hover:border-emerald-500 dark:hover:border-emerald-500 transition-all text-left shadow-sm hover:shadow-xl flex flex-col">
                        ...
                        <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-2">General Chemistry</h3>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4 flex-1">Comprehensive mock test covering basic to advanced concepts.</p>
                        <div className="flex items-center gap-3 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-6">
                        ...
                        {quizProgress['SAMPLE_QUIZ']?.answers?.length > 0 ? (
                          ...
                          <button 
                            onClick={() => startQuiz('SAMPLE_QUIZ', false)}
                            className="w-full py-2.5 bg-slate-900 dark:bg-slate-800 text-white rounded-xl font-bold text-sm hover:bg-black dark:hover:bg-slate-700 transition-colors mt-auto"
                          >
                            Start Test
                          </button>
                        )}
                      ...
                      <div className="group bg-white dark:bg-slate-900 p-6 rounded-3xl border-2 border-slate-100 dark:border-slate-800 hover:border-indigo-500 dark:hover:border-indigo-500 transition-all text-left shadow-sm hover:shadow-xl flex flex-col">
                        ...
                        <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-2">IIT JAM Special</h3>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4 flex-1">Curated questions specifically for IIT JAM Chemistry aspirants.</p>
                        <div className="flex items-center gap-3 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-6">
                    ...
                    {!showReview ? (
                      <div className="flex flex-wrap justify-center gap-4 mt-8 w-full max-w-md">
                        ...
                        <button 
                          ...
                          className="px-8 py-4 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-full font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-all active:scale-95"
                        >
                      ...
                      <>
                        <div className="w-full max-w-2xl space-y-4 mt-8">
                          <h3 className="text-sm font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest px-2">Detailed Review</h3>
                          {activeQuiz.map((q, idx) => (
                            <div key={q.id} className={cn(
                              "bg-white dark:bg-slate-900 p-6 rounded-3xl border-2 transition-all shadow-sm",
                              userAnswers[idx] === q.correctAnswer ? "border-emerald-100 dark:border-emerald-900/50" : "border-rose-100 dark:border-rose-900/50"
                            )}>
                              <div className="flex items-start gap-4">
                                <div className={cn(
                                  "w-8 h-8 rounded-full flex items-center justify-center shrink-0 mt-1",
                                  userAnswers[idx] === q.correctAnswer ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400" : "bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400"
                                )}>
                                  {userAnswers[idx] === q.correctAnswer ? <CheckCircle2 size={18} /> : <X size={18} />}
                                </div>
                                <div className="space-y-4 flex-1">
                                  <p className="font-bold text-slate-800 dark:text-slate-200 leading-snug">{q.text}</p>
                                  
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div className={cn(
                                      "p-3 rounded-xl text-xs",
                                      userAnswers[idx] === q.correctAnswer ? "bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 border border-emerald-100 dark:border-emerald-800" : "bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-300 border border-rose-100 dark:border-rose-800"
                                    )}>
                                    ...
                                    {userAnswers[idx] !== q.correctAnswer && (
                                      <div className="p-3 rounded-xl text-xs bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 border border-emerald-100 dark:border-emerald-800">
                                  ...
                                  {q.explanation && (
                                    <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-2xl border border-slate-100 dark:border-slate-700">
                                      <p className="text-xs text-slate-500 dark:text-slate-400 italic leading-relaxed">
                                        <span className="font-bold text-slate-700 dark:text-slate-300 not-italic mr-1">Explanation:</span>
                                        {q.explanation}
                                      </p>
                                    </div>
                                  )}
                  ...
                  <div className="flex-1 flex flex-col py-8 overflow-hidden relative">
                    ...
                    <div className="flex items-center justify-between mb-8 mt-2">
                      <div className="flex items-center gap-4">
                        <button 
                          ...
                          className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
                        >
                          <X size={20} />
                        </button>
                        <div className="flex flex-col">
                          <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest leading-none mb-1">Assessment In Progress</span>
                          <span className="font-black text-slate-800 dark:text-slate-200 text-lg">Question {currentQuestionIndex + 1} <span className="text-slate-300 dark:text-slate-600 font-medium">/ {activeQuiz.length}</span></span>
                        </div>
                      </div>
                        ...
                        {activeQuiz.map((_, idx) => (
                          <div 
                            ...
                            className={cn(
                              ...
                              idx < currentQuestionIndex ? "bg-emerald-200 dark:bg-emerald-900/50" : "bg-slate-200 dark:bg-slate-800"
                            )}
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex items-center gap-4">
                        {isTimedMode && timeRemaining !== null && (
                          <div className="flex items-center gap-2 px-3 py-1.5 bg-red-50 dark:bg-red-900/20 rounded-full border border-red-100 dark:border-red-800">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-amber-50 dark:bg-amber-900/20 rounded-full border border-amber-100 dark:border-amber-800">
                          ...
                          <span className="text-[10px] font-bold text-amber-700 dark:text-amber-400 uppercase tracking-wider">Live Test</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 space-y-8 overflow-y-auto pr-2">
                      <div className="space-y-4">
                        <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-full text-[10px] font-bold uppercase tracking-wider">Multiple Choice</span>
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              userAnswers[currentQuestionIndex] === idx 
                                ? "bg-emerald-50 dark:bg-emerald-900/20 border-emerald-500 dark:border-emerald-500 shadow-lg shadow-emerald-50 dark:shadow-none" 
                                : "bg-white dark:bg-slate-900 border-slate-100 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700"
                            )}
                          >
                            <span className={cn(
                              "font-medium",
                              userAnswers[currentQuestionIndex] === idx ? "text-emerald-700 dark:text-emerald-300" : "text-slate-600 dark:text-slate-300"
                            )}>
                              {option}
                            </span>
                            <div className={cn(
                    ...
                    <div className="mt-12 flex justify-between items-center">
                      ...
                      <button 
                        ...
                        disabled={userAnswers[currentQuestionIndex] === undefined}
                        className="px-10 py-4 bg-slate-900 dark:bg-slate-800 text-white rounded-full font-bold disabled:opacity-50 disabled:cursor-not-allowed hover:bg-black dark:hover:bg-slate-700 transition-all flex items-center gap-2"
                      >
              ...
              >
                {!selectedLoreId ? (
                  <div className="space-y-8">
                    <div className="space-y-2">
                      <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-100">Lore Labs</h2>
                      <p className="text-slate-500 dark:text-slate-400">Immersive story-driven chemistry simulations.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {LORE_MISSIONS.map(mission => (
                        <div 
                          ...
                          className="bg-white dark:bg-slate-900 p-6 rounded-3xl border-2 border-slate-100 dark:border-slate-800 hover:border-emerald-500 dark:hover:border-emerald-500 transition-all cursor-pointer shadow-sm hover:shadow-xl hover:-translate-y-1 group"
                        >
                          <div className="w-12 h-12 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            <FlaskConical size={24} />
                          </div>
                          <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-2">{mission.title}</h3>
                          <p className="text-sm font-bold text-emerald-600 dark:text-emerald-400 mb-3 uppercase tracking-wider">{mission.topic}</p>
                          <p className="text-sm text-slate-500 dark:text-slate-400 line-clamp-3">{mission.loreText}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-8 pb-12">
                    ...
                    {LORE_MISSIONS.filter(m => m.id === selectedLoreId).map(mission => (
                      <div key={mission.id} className="space-y-8">
                        ...
                        <div className="space-y-4">
                          <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200">Select Simulation Mode</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <button 
                              onClick={() => setSelectedLoreMode('learner')}
                              className="bg-white dark:bg-slate-900 p-8 rounded-3xl border-2 border-slate-100 dark:border-slate-800 hover:border-emerald-500 dark:hover:border-emerald-500 transition-all text-left shadow-sm hover:shadow-xl group"
                            >
                              <div className="flex items-center justify-between mb-6">
                                <div className="w-14 h-14 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                  <Beaker size={28} />
                                </div>
                                <span className="px-3 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-bold uppercase tracking-wider rounded-full">Learner</span>
                              </div>
                              <h4 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-2">{mission.modes.learner.title}</h4>
                              <p className="text-slate-500 dark:text-slate-400 mb-6">{mission.modes.learner.goal}</p>
                              <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-bold text-sm group-hover:translate-x-1 transition-transform">
                            ...
                            <button 
                              ...
                              className="bg-white dark:bg-slate-900 p-8 rounded-3xl border-2 border-slate-100 dark:border-slate-800 hover:border-indigo-500 dark:hover:border-indigo-500 transition-all text-left shadow-sm hover:shadow-xl group"
                            >
                              <div className="flex items-center justify-between mb-6">
                                ...
                                <span className="px-3 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-xs font-bold uppercase tracking-wider rounded-full">Gamer</span>
                              </div>
                              <h4 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-2">{mission.modes.gamer.title}</h4>
                              <p className="text-slate-500 dark:text-slate-400 mb-6">{mission.modes.gamer.goal}</p>
                  ...
                  <div className="h-full flex flex-col">
                    <button 
                      ...
                      className="flex items-center gap-2 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors font-medium mb-6 shrink-0"
                    >
                        ...
                        <div key={mode.id} className="flex-1 flex flex-col xl:flex-row gap-8 overflow-y-auto xl:overflow-hidden pb-8 xl:pb-0">
                          ...
                          <div className="w-full xl:w-1/3 flex flex-col gap-6 xl:overflow-y-auto pr-2 xl:pb-8 shrink-0 xl:shrink">
                            <div className="space-y-2">
                              <span className={cn(
                                ...
                                selectedLoreMode === 'learner' ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400" : "bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400"
                              )}>
                                {mode.targetAudience}
                              </span>
                              <h2 className="text-3xl font-black text-slate-800 dark:text-slate-100 tracking-tight">{mode.title}</h2>
                            </div>
                            
                            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
                              <div>
                                <h4 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1">Goal</h4>
                                <p className="text-slate-700 dark:text-slate-300 font-medium">{mode.goal}</p>
                              </div>
                              <div className="h-px bg-slate-100 dark:bg-slate-800" />
                              <div>
                                <h4 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1">Interface</h4>
                                <p className="text-slate-600 dark:text-slate-400 text-sm">{mode.interfaceDesc}</p>
                              </div>
                            </div>

                            <div className="space-y-3">
                              <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider">Gameplay Mechanics</h4>
                              {mode.gameplay.map((step, i) => (
                                <div key={i} className="flex gap-3 bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                                  <div className="w-6 h-6 rounded-full bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center justify-center text-xs font-bold shrink-0">
                                    {i + 1}
                                  </div>
                            ...
                            {mode.whyItWorks && (
                              <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-xl border border-emerald-100 dark:border-emerald-900/30">
                                <h4 className="text-xs font-bold text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mb-1">Why It Works</h4>
                                <p className="text-sm text-emerald-800 dark:text-emerald-300">{mode.whyItWorks}</p>
                              </div>
                            )}

                            {mode.hook && (
                              <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-xl border border-amber-100 dark:border-amber-900/30">
                                <h4 className="text-xs font-bold text-amber-600 dark:text-amber-500 uppercase tracking-widest mb-1">The Hook</h4>
                                <p className="text-sm text-amber-800 dark:text-amber-300">{mode.hook}</p>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="flex-1 bg-slate-900 rounded-3xl overflow-hidden relative shadow-2xl flex flex-col border border-slate-800 min-h-[500px] xl:min-h-0 shrink-0 xl:shrink">
                            <div className="h-12 bg-slate-950 border-b border-slate-800 flex items-center px-4 gap-2 shrink-0">
                              ...
                              <span className="ml-2 sm:ml-4 text-xs font-mono text-slate-500 dark:text-slate-400 truncate">{mode.interfaceDesc}</span>
                            </div>
            ...
            {activeTab === 'resume' && (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="space-y-2">
                    <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">My Resume</h2>
                    <p className="text-slate-500 dark:text-slate-400">Your professional profile generated from your study progress.</p>
                  </div>
                  <button 
                    onClick={() => {
                      ...
                      if (element) {
                        html2canvas(element, { scale: 2 }).then(canvas => {
                          ...
                          const pdfHeight = (canvas.height * pdfWidth) / canvas.width;
                          pdf.addImage(imgData, 'PNG', 0, 0, pdfWidth, pdfHeight);
                          pdf.save('My_Chemistry_Resume.pdf');
                        });
                      }
                    }}
                ...
                <div 
                  id="resume-content" 
                  className="bg-white dark:bg-slate-900 p-12 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm"
                ...
                >
                  ...
                  <div className="space-y-8">
                    <section>
                      <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-4 uppercase tracking-wider text-sm border-b border-slate-200 dark:border-slate-800 pb-2">Education</h2>
                      <div className="space-y-4">
                        <div>
                          <div className="flex justify-between items-start">
                            <h3 className="font-bold text-slate-800 dark:text-slate-200">M.Sc. in Chemistry</h3>
                            <span className="text-sm font-medium text-slate-500 dark:text-slate-400">2024 - Present</span>
                          </div>
                          <p className="text-slate-600 dark:text-slate-400 text-sm">Indian Institute of Technology (IIT), Delhi</p>
                          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">CGPA: 9.2/10.0</p>
                        </div>
                        <div>
                          <div className="flex justify-between items-start">
                            <h3 className="font-bold text-slate-800 dark:text-slate-200">B.Sc. (Hons) Chemistry</h3>
                            <span className="text-sm font-medium text-slate-500 dark:text-slate-400">2021 - 2024</span>
                          </div>
                          <p className="text-slate-600 dark:text-slate-400 text-sm">University of Delhi</p>
                          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Percentage: 88%</p>
                        </div>
                      </div>
                    </section>

                    <section>
                      <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-4 uppercase tracking-wider text-sm border-b border-slate-200 dark:border-slate-800 pb-2">Competitive Exams</h2>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-lg border border-slate-100 dark:border-slate-800">
                          <h3 className="font-bold text-slate-800 dark:text-slate-200">GATE Chemistry 2025</h3>
                          <p className="text-emerald-600 dark:text-emerald-400 font-medium text-sm mt-1">Targeting Top 100 Rank</p>
                          <p className="text-slate-500 dark:text-slate-400 text-xs mt-2">Completed 12+ Mock Tests with 85% avg. score</p>
                        </div>
                        <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-lg border border-slate-100 dark:border-slate-800">
                          <h3 className="font-bold text-slate-800 dark:text-slate-200">IIT JAM 2024</h3>
                          <p className="text-emerald-600 dark:text-emerald-400 font-medium text-sm mt-1">All India Rank: 142</p>
                          <p className="text-slate-500 dark:text-slate-400 text-xs mt-2">Secured admission to IIT Delhi</p>
                        </div>
                      </div>
                    </section>

                    <section>
                      <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-4 uppercase tracking-wider text-sm border-b border-slate-200 dark:border-slate-800 pb-2">Core Competencies</h2>
                      <div className="flex flex-wrap gap-2">
                        {['Organic Synthesis', 'Quantum Chemistry', 'Spectroscopy (NMR, IR, UV-Vis)', 'Chemical Kinetics', 'Coordination Chemistry', 'Thermodynamics', 'Chromatography'].map(skill => (
                          <span key={skill} className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 px-3 py-1 rounded-full text-sm font-medium">
                            {skill}
                          </span>
                        ))}
                      </div>
                    ...
                    <section>
                      <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-4 uppercase tracking-wider text-sm border-b border-slate-200 dark:border-slate-800 pb-2">Projects & Research</h2>
                      <div className="space-y-4">
                        <div>
                          <h3 className="font-bold text-slate-800 dark:text-slate-200">Synthesis of Novel Transition Metal Catalysts</h3>
                          <p className="text-slate-500 dark:text-slate-400 text-sm mb-2">Undergraduate Thesis • Jan 2024 - May 2024</p>
                          <ul className="list-disc list-inside text-sm text-slate-600 dark:text-slate-400 space-y-1">
                            <li>Designed and synthesized 3 novel Palladium-based catalysts for cross-coupling reactions.</li>
                            <li>Characterized compounds using 1H-NMR, 13C-NMR, and Mass Spectrometry.</li>
                            <li>Achieved a 15% increase in reaction yield compared to standard commercial catalysts.</li>
                          </ul>
                        </div>
                      </div>
                    </section>
            ...
            {activeTab === 'settings' && (
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-slate-500 dark:text-slate-400">Manage your study preferences and account.</p>
                </div>

                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
                  <div className="p-6 border-b border-slate-100 dark:border-slate-800">
                    <h3 className="font-bold text-slate-800 dark:text-slate-200">Study Preferences</h3>
                  </div>
                  <div className="p-6 space-y-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-semibold text-sm text-slate-800 dark:text-slate-300">Exam Focus</p>
                        <p className="text-xs text-slate-500 dark:text-slate-400">Select which exams you are preparing for.</p>
                      </div>
                      <select className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-1.5 text-sm dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/20">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-semibold text-sm text-slate-800 dark:text-slate-300">Daily Goal</p>
                        <p className="text-xs text-slate-500 dark:text-slate-400">Set your target study hours per day.</p>
                      </div>
                      <div className="flex items-center gap-2">
                        <input type="number" defaultValue={4} className="w-16 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-1.5 text-sm text-center dark:text-slate-200" />
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
                  ...
                  <div className="p-6 space-y-4">
                    <label className="flex items-center justify-between cursor-pointer group">
                      <span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-slate-100 transition-colors">Study Reminders</span>
                    ...
                    <label className="flex items-center justify-between cursor-pointer group">
                      <span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-slate-100 transition-colors">New Paper Alerts</span>
                      <div className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" defaultChecked className="sr-only peer" />
                        <div className="w-11 h-6 bg-slate-200 dark:bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600"></div>
                      </div>
...
function SidebarItem({ icon, label, active, onClick, collapsed }: { icon: React.ReactNode, label: string, active?: boolean, onClick: () => void, collapsed: boolean }) {
  return (
    ...
    >
      <div className={cn(
        "transition-colors",
        active ? "text-emerald-600 dark:text-emerald-400" : "group-hover:text-slate-700 dark:group-hover:text-slate-200"
      )}>
        {icon}
      </div>
      {!collapsed && (
      ...
      {active && (
        <motion.div 
          ...
          className="absolute left-0 w-1 h-6 bg-emerald-600 dark:bg-emerald-500 rounded-r-full"
        />
      )}
    </button>
  );
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 px-2 py-1 rounded-full">{trend}</span>
      </div>
