            ...
            {activeTab === 'resume' && (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="space-y-2">
                    <h2 className="text-2xl font-bold text-slate-800">My Resume</h2>
                    <p className="text-slate-500">Your professional profile generated from your study progress.</p>
                  </div>
                  <button 
                    onClick={() => {
                ...
                <div 
                  id="resume-content" 
                  className="bg-white p-12 rounded-2xl border border-slate-200 shadow-sm"
                  style={{ minHeight: '800px' }}
                >
                  <div className="border-b-2 border-slate-800 pb-6 mb-8">
                    <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-2">Alex Chemist</h1>
                    <p className="text-lg text-emerald-600 font-medium">Aspiring Research Scientist & GATE Aspirant</p>
                  ...
                  <div className="space-y-8">
                    <section>
                      <h2 className="text-xl font-bold text-slate-800 mb-4 uppercase tracking-wider text-sm border-b border-slate-200 pb-2">Education</h2>
                      <div className="space-y-4">
                        <div>
                          <div className="flex justify-between items-start">
                            <h3 className="font-bold text-slate-800">M.Sc. in Chemistry</h3>
                            <span className="text-sm font-medium text-slate-500">2024 - Present</span>
                          </div>
                          <p className="text-slate-600 text-sm">Indian Institute of Technology (IIT), Delhi</p>
                          <p className="text-slate-500 text-sm mt-1">CGPA: 9.2/10.0</p>
                        </div>
                        <div>
                          <div className="flex justify-between items-start">
                            <h3 className="font-bold text-slate-800">B.Sc. (Hons) Chemistry</h3>
                            <span className="text-sm font-medium text-slate-500">2021 - 2024</span>
                          </div>
                          <p className="text-slate-600 text-sm">University of Delhi</p>
                          <p className="text-slate-500 text-sm mt-1">Percentage: 88%</p>
                        </div>
                      </div>
                    </section>

                    <section>
                      <h2 className="text-xl font-bold text-slate-800 mb-4 uppercase tracking-wider text-sm border-b border-slate-200 pb-2">Competitive Exams</h2>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                          <h3 className="font-bold text-slate-800">GATE Chemistry 2025</h3>
                          <p className="text-emerald-600 font-medium text-sm mt-1">Targeting Top 100 Rank</p>
                          <p className="text-slate-500 text-xs mt-2">Completed 12+ Mock Tests with 85% avg. score</p>
                        </div>
                        <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                          <h3 className="font-bold text-slate-800">IIT JAM 2024</h3>
                          <p className="text-emerald-600 font-medium text-sm mt-1">All India Rank: 142</p>
                          <p className="text-slate-500 text-xs mt-2">Secured admission to IIT Delhi</p>
                        </div>
                      </div>
                    </section>

                    <section>
                      <h2 className="text-xl font-bold text-slate-800 mb-4 uppercase tracking-wider text-sm border-b border-slate-200 pb-2">Core Competencies</h2>
                    ...
                    <section>
                      <h2 className="text-xl font-bold text-slate-800 mb-4 uppercase tracking-wider text-sm border-b border-slate-200 pb-2">Projects & Research</h2>
                      <div className="space-y-4">
                        <div>
                          <h3 className="font-bold text-slate-800">Synthesis of Novel Transition Metal Catalysts</h3>
                          <p className="text-slate-500 text-sm mb-2">Undergraduate Thesis • Jan 2024 - May 2024</p>
